...
useGSAP(() => {
  ...
  return (
    <div id='majd' className='min-h-screen relative'>
        ...
        <img src="/items/item1.png" className='item willfade floating top-85 left-10 md:top-100 md:left-50 xl:top-60 xl:left-80 d1'/>
        <img src='/items/item2.png' className='item willfade floating bottom-85 right-8 md:bottom-135 md:right-45 xl:top-100 xl:right-85 d2'/>
        <img src='/items/item3.png' className='item willfade floating top-72 right-13 md:top-95 md:right-50 xl:top-55 xl:right-100 d3'/>
        <img src='/items/item4.png' className='item willfade floating bottom-70 left-10 md:bottom-120 xl:top-105 md:left-40 xl:left-90 d4'/>
        <img src='MajdIcon.png' className='absolute top-105! -translate-y-1/2 left-1/2 -translate-x-1/2 w-50 z-100 willfade md:top-170! xl:top-74! md:w-105 xl:w-85 max-md:top-75'/>
